 ...
 */
final class Version20200413162503 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE short_list ADD CONSTRAINT FK_240F368DB4B6DCC3 FOREIGN KEY (short_list_charge_id) REFERENCES charge (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
